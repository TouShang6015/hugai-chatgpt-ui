<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="76px">
      <el-form-item label="任务名称" prop="jobName">
        <el-input
          ...
          placeholder="请输入任务名称"
          clearable
          @keyup.enter.native="baseHandleQuery"
        />
      </el-form-item>
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          :disabled="single"
          @click="baseHandleEdit(null,true)"
    ...
    <!-- 添加或修改定时任务对话框 -->
    <el-dialog :title="title" :visible.sync="dialog" width="800px" append-to-body>
...
<script>
import { runJob, changeJobStatus } from "/src/api/monitor/job";
...
export default {
  ...
  methods: {
    ...
    /** 任务详细信息 */
    handleView(row) {
      this.getRestfulRequest('baseQueryById',row.id).then(response => {
